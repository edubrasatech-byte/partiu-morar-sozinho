...
export function CleanNavbar() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-slate-200 py-3.5 px-4 sm:px-8 shadow-xs">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        {/* Brand Logo */}
        <Link href="/" className="flex items-center gap-2.5 group">
          <div className="w-9 h-9 bg-emerald-600 text-white font-extrabold text-lg flex items-center justify-center rounded-xl shadow-sm group-hover:scale-105 transition-transform">
            #
          </div>
          <div className="flex flex-col">
            ...
            <span className="text-[10px] text-emerald-600 font-semibold uppercase tracking-wider -mt-1">
      ...
      {/* Mobile Menu Drawer */}
      {mobileMenuOpen && (
        <div className="lg:hidden mt-3 pt-4 border-t border-slate-100 space-y-3 font-semibold text-xs uppercase tracking-wider text-slate-700">
